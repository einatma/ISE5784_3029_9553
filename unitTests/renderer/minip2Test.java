...
public class minip2Test {
     ...
     * Scene of the tests
     */
    private final Scene scene = new Scene("minip2 scene");
...
//            .setDebugPrint(0.1);
    ...
    public void renderCastleScene() {
        ...
        scene.lights.add(new SpotLight(new Color(255, 255, 77),new Point(-110, -80, 10), new Vector(0.0001,1,0.01)).setKc(0.0005).setKl(0.000005).setKq(0.0005));
        ...
        scene.geometries.add(new Sphere(new Point(-120, 10, 7), 10)
                .setEmission(new Color(GREEN)).setMaterial(new Material().setKd(0).setKs(0.2).setKt(0.2).setKr(0).setShininess(0)));
        scene.geometries.add(new Sphere(new Point(-135, -50, 0), 9)
                .setEmission(new Color(BLUE)).setMaterial(new Material().setKd(0).setKs(0.4).setKt(0.2).setKr(0).setShininess(100)));
...
//adding grass patches
        ...
        // Rendering the image
        camera.setImageWriter(new ImageWriter("Minip2WithBvhAndDof", 1000, 1000))
                .build()
                .renderImage();

//        // Rendering the image
//        camera.setImageWriter(new ImageWriter("Minip2WithBvhOnly", 1000, 1000))
//                .build()
//                .renderImage();
