...
public class ReflectionRefractionTests {
     ...
     */
    private final Camera.Builder cameraBuilder = Camera.getBuilder().setLocation(new Point(0, 0, 1000))
    ...
    /**
     * Produce a picture of four objects lighted by spot lights with varied positions and colors.
     * The scene includes two triangles and two spheres with different materials and lighting effects.
     * The triangles are positioned to form a basic structure, while the spheres add complexity
     * with different emission colors and transparent properties, demonstrating reflection and refraction.
     * <p>
     * This test scene showcases the use of ambient light, spot lights, and material properties to create
