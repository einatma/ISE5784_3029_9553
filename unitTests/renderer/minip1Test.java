...
//            .setVpSize(500, 500);
    ...
    public void renderCastleScene() {
        ...
        for (int i = 0; i < 9; i++) {
            Sailboat sailboat = new Sailboat(new Point(shipLocationX, Math.random() * 3000 - 1200, 0), 20, 30, 40, 1, 70, 40, 50, new Vector(-1, -1, 0), new Vector(1, 1, 0).crossProduct(new Vector(0, 0, 1)))
                    .setBoatEmission(boatColor).setSailEmission(sailColor).setBoatMaterial(boatMaterial).setSailMaterial(sailMaterial);
