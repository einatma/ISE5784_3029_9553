...
//            .setVpSize(500, 500);
    ...
    public void renderCastleScene() {
        ...
        Point frontLeftTurretPosition = new Point(-100, -70, 0);
        ...
        Point frontRightTurretPosition = new Point(70, -70, 0);
        ...
        Point backLeftTurretPosition = new Point(-100, 100, 0);
        ...
        Point backRightTurretPosition = new Point(70, 100, 0);
        ...
        Point housePosition = new Point(-50, -60, 0);
...
// Dimensions for side towers
        double towerSideWidthAndLength = 20;
        double towerHeight = 70;
        double towerRoofHeight = 30;

// Creating the towers around the house
        Point towerFrontLeftPosition = house.getBase().getFrontBottomLeft().add(new Vector(-towerSideWidthAndLength,0,0));
        House towerFrontLeft = new House(towerFrontLeftPosition, towerSideWidthAndLength, towerSideWidthAndLength, towerHeight, towerRoofHeight, new Vector(1, 0, 0), new Vector(0, 1, 0))
                .setBaseEmission(wallColor)
                .setRoofEmission(roofColor)
                .setBaseMaterial(buildingsMaterial)
                .setRoofMaterial(buildingsMaterial);
        ...
        House towerFrontRight = new House(towerFrontRightPosition, towerSideWidthAndLength, towerSideWidthAndLength, towerHeight, towerRoofHeight, new Vector(1, 0, 0), new Vector(0, 1, 0))
                .setBaseEmission(wallColor)
                .setRoofEmission(roofColor)
                .setBaseMaterial(buildingsMaterial)
                .setRoofMaterial(buildingsMaterial);

        Point towerBackLeftPosition = house.getBase().getBackBottomLeft().add(new Vector(-towerSideWidthAndLength,-towerSideWidthAndLength,0));
        House towerBackLeft = new House(towerBackLeftPosition, towerSideWidthAndLength, towerSideWidthAndLength, towerHeight, towerRoofHeight, new Vector(1, 0, 0), new Vector(0, 1, 0))
                .setBaseEmission(wallColor)
                .setRoofEmission(roofColor)
                .setBaseMaterial(buildingsMaterial)
                .setRoofMaterial(buildingsMaterial);

        Point towerBackRightPosition = house.getBase().getBackBottomRight().add(new Vector(0,-towerSideWidthAndLength,0));
        House towerBackRight = new House(towerBackRightPosition, towerSideWidthAndLength, towerSideWidthAndLength, towerHeight, towerRoofHeight, new Vector(1, 0, 0), new Vector(0, 1, 0))
                .setBaseEmission(wallColor)
                .setRoofEmission(roofColor)
                .setBaseMaterial(buildingsMaterial)
                .setRoofMaterial(buildingsMaterial);
        ...
        allGeometries.addAll(towerFrontRight.getHouseWigs());
        allGeometries.addAll(towerFrontLeft.getHouseWigs());
        allGeometries.addAll(towerBackRight.getHouseWigs());
        allGeometries.addAll(towerBackLeft.getHouseWigs());
        ...
        Geometry sun  =  new Sphere(new Point(0, -50, 240), 10)
                .setEmission(new Color(255, 223, 0))  // צבע צהוב עז
                .setMaterial(new Material().setKt(0).setKd(0.9).setKs(0.1).setKr(0).setShininess(300));
        ...
        double grossWidth = 5;
        double grossHeight = 10;
// הוספת גבעולי דשא בתלת-ממד באמצעות משולשים מצטלבים עם צל
        // הוספת גבעולי דשא בצורה מפוזרת על המשטח הירוק במקומות החדשים
        addGrassPatch(new Point(-60, -90, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(20, -100, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(-30, -60, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(60, -80, 1), grossWidth, grossHeight, grassMaterial);   // מיקום חדש כדי להרחיק מהמים
        addGrassPatch(new Point(0, 0, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(-50, 40, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(50, 40, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(-80, -90, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(80, -90, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(-60, -50, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(60, -50, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(-40, -30, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(40, -30, 1), grossWidth, grossHeight, grassMaterial);
        addGrassPatch(new Point(70, -100, 1), grossWidth, grossHeight, grassMaterial);
