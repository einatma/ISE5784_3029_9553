...
class PlaneTests {
    ...
    public void testfindIntersections() {
        ...
        assertEquals(List.of(new Point(0, 0, 1)),
                plane.findIntersections(new Ray(new Point(0, 0, 2), new Vector(0, 0, -1)),Double.POSITIVE_INFINITY),
        ...
        assertNull(plane.findIntersections(new Ray(new Point(2, 2, 2), new Vector(1, 0, 0)), Double.POSITIVE_INFINITY),
                "The point supposed to be outside the plane");

        // ================== Boundary Values Tests ==================
        // *********Group: Ray is parallel to the plane
        // TC11: The ray is parallel to the plane and not included in it
        assertNull(plane.findIntersections(new Ray(new Point(1, 1, 2), new Vector(1, 1, 0)), Double.POSITIVE_INFINITY),
                "The ray is parallel to the plane and not included in it");

        // TC12: The ray is parallel to the plane and included in it
        assertNull(plane.findIntersections(new Ray(new Point(1, 1, 1), new Vector(1, 1, 0)),Double.POSITIVE_INFINITY ),
                "The ray is parallel to the plane and included in it");

        // *********Group: Ray is orthogonal to the plane
        // TC21: The ray is orthogonal to the plane and starts after it
        assertNull(plane.findIntersections(new Ray(new Point(0, 0, 2), new Vector(0, 0, 1)), Double.POSITIVE_INFINITY),
                "The ray is orthogonal to the plane and starts after it");

        // TC22: The ray is orthogonal to the plane and starts before it
        assertEquals(List.of(new Point(0, 0, 1)),
                plane.findIntersections(new Ray(new Point(0, 0, 0), new Vector(0, 0, 1)), Double.POSITIVE_INFINITY),
                "The ray is orthogonal to the plane and starts before it");

        // TC23: The ray is orthogonal to the plane and starts in it
        assertNull(plane.findIntersections(new Ray(new Point(0, 0, 1), new Vector(0, 0, 1)), Double.POSITIVE_INFINITY),
        ...
        assertNull(plane.findIntersections(new Ray(new Point(0, 0, 1), new Vector(1, 1, 1)), Double.POSITIVE_INFINITY),
        ...
        assertNull(plane1.findIntersections(new Ray(new Point(1, 1, 1), new Vector(1, 1, 1)), Double.POSITIVE_INFINITY),
